    ...
    >
      <el-row type="flex">
        ...
        <el-col :span="8">
          <el-row type="flex">
            <el-col :span="8">
              <el-input placeholder="请输入内容" suffix-icon="el-icon-search" v-model="search" class="click-btn"></el-input>
            </el-col>
            <el-col :span="4"></el-col>
            <el-col :span="4">
              <div @click="writeMarkDown" class="click-btn" :class="{ colorBlack: showMarkDown }">写文章</div>
            </el-col>
            <el-col :span="4">
